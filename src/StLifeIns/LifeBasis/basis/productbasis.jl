struct ProductBasis <: Basis
    ...
    v::CuArray{Float32, 2}
    """
        ProductBasis(nsims::Int64, proj::Int16, mortality::Dict{Bool, MortalityForecasts}, surrender_rates::CuArray{Float32, 2}, int::CuArray{Float32, 2}, infl::CuArray{Float32, 2})
    ...
    """
    function ProductBasis(nsims::Int64, proj::Int16, mortality::Dict{Bool, MortalityForecasts}, surrender_rates::Matrix{Float64}, int::Matrix{Float64}, infl::Matrix{Float64})
        int_acc = 1 .+ int
    ...
    function ProductBasis(nsims::Int64, proj::Int16, mortality::Dict{Bool, MortalityForecasts}, surrender_rates::CuArray{Float32, 2}, cum_infl::CuArray{Float32, 2}, int_acc::CuArray{Float32, 2}, v::CuArray{Float32, 2})
        return new(nsims, proj, mortality, surrender_rates, cum_infl, int_acc, v)
    end
end

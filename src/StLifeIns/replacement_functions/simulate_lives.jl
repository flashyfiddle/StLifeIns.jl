...
function simulate_life(probabilities::BigProbDictGPU, nsims::Integer, proj_max::Integer)::BigRealisedProbDictGPU
...
function simulate_life(probabilities::BigProbDictGPU, pb::PolicyBasis)::BigRealisedProbDictGPU

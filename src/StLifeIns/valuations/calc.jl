function value(cfs::CompleteCashflows, prob::BigProbDictGPU, pb::PolicyBasis)::CuArray{Float64, 1}
    return calc(cfs, prob, pb.int_acc, pb.v, pb.nsims, pb.proj_max)
end


function calc(cfs::CompleteCashflows, prob::BigProbDictGPU, int_acc::CuArray{Float32, 2}, v::Union{Float64, CuArray{Float32, 2}}, nsims::Int64, proj_max::Int16)::CuArray{Float64, 1}
    return iterate_calc(cfs, prob, int_acc, v, nsims, proj_max)[:, 1]
end


function iterate_calc(cfs::CompleteCashflows, prob::BigProbDictGPU, int_acc::CuArray{Float32, 2}, v::CuArray{Float32, 2}, nsims::Int64, proj_max::Int16)::CuArray{Float64, 2}
...
function iterate_calc(cfs::CompleteCashflows, prob::BigProbDictGPU, int_acc::CuArray{Float32, 2}, v::Float64, nsims::Int64, proj_max::Int16)::CuArray{Float64, 2}
    totals = get_totals(cfs, prob, int_acc, nsims, proj_max)
    inforce = prob[InForce()]
...
function get_totals(cfs::CompleteCashflows, prob::BigProbDictGPU, int_acc::CuArray{Float32, 2}, nsims::Int64, proj_max::Int16)::CuArray{Float64, 2}
...
function apply_probability(cf::VectorCashflow, prob::BigProbDictGPU)::CuArray{Float64, 2}
    return transpose(cf.amount) .* prob[cf.contingency]
end

function apply_probability(cf::PointCashflow, prob::BigProbDictGPU)::CuArray{Float64, 1}
...
function apply_probability(cf::ParallelVectorCashflow, prob::BigProbDictGPU)::CuArray{Float64, 2}
    return cf.amount .* prob[cf.contingency]
end

function apply_probability(cf::ParallelPointCashflow, prob::BigProbDictGPU)::CuArray{Float64, 1}
